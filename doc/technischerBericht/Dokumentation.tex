...
\begin{document}
  ...
  \begin{description}
    ...
    Server deployed werden. Es soll geprüft werden, ob die Applikation läuft.
         
    % Client Android Version
    \item[T-10.1] Die Clientapplikation soll auf einem Android 2.2 installiert
    werden. Es soll geprüft werden, ob die Applikation läuft.
  ...
  möglich mit Unittests abgedeckt werden. Wenn es keine möglichkeit eines Unit
  Tests gibt, kann ein Test auch manuell ausgeführt und auf einen Erfolg
  geprüft werden.
  
  Unittests in Java werden normalerweist mit JUnit durchgeführt. Für das Android
  Betriebsystem wird eine Testing-Engine mit dem SDK mitgeliefert, mit der man
  Unittests definieren kann.
  
  Manuelle Tests werden von mir selber überprüft und nach Treu und Glauben für
  korrekt oder fehlgeschlagen erklärt.
